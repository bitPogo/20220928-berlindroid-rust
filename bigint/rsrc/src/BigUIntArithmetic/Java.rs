...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_add(
    env: JNIEnv,
    _: JObject,
    summand1: jbyteArray,
    summand2: jbyteArray
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_subtract(
    env: JNIEnv,
    _: JObject,
    minuend: jbyteArray,
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_multiply(
    env: JNIEnv,
    _: JObject,
    factor1: jbyteArray,
    factor2: jbyteArray
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_divide(
    env: JNIEnv,
    _: JObject,
    dividend: jbyteArray,
    divisor: jbyteArray
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_remainder(
    env: JNIEnv,
    _: JObject,
    number: jbyteArray,
    modulus: jbyteArray
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_gcd(
    env: JNIEnv,
    _: JObject,
    number: jbyteArray,
    modulus: jbyteArray
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_shiftLeft(
    env: JNIEnv,
    _: JObject,
    number: jbyteArray,
    shifts: jlong
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_shiftRight(
    env: JNIEnv,
    _: JObject,
    number: jbyteArray,
    shifts: jlong
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_modPow(
    env: JNIEnv,
    _: JObject,
    base: jbyteArray,
    exponent: jbyteArray,
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_modInverse(
    env: JNIEnv,
    _: JObject,
    number: jbyteArray,
    modulus: jbyteArray,
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_intoString(
    env: JNIEnv,
    _: JObject,
    number: jbyteArray,
    radix: jint,
...
#[no_mangle]
pub unsafe extern fn Java_io_bitpogo_rustkmp_bignumber_BigUIntArithmetic_compare(
    env: JNIEnv,
    _: JObject,
    number: jbyteArray,
    other: jbyteArray,
